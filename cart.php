...
?>
        ...
        <section id="model">
                <div id="box">
                    ...
                    <div class = "checkout-order">
                        <div class="modal">
                            <form class="form" id = "card-detail-form">
                                ...
                                <div class="credit-card-info--form">
                                    <div class="input_container">
                                        ...
                                        <input id="password_field" class="input_field" type="text" name="card_name" title="Inpit title" placeholder="Enter your full name">
                                    </div>
                                    <div class="input_container">
                                        <label for="password_field" class="input_label">Card Number</label>
                                        <input id="password_field" class="input_field" type="number" name="card_number" title="Inpit title" placeholder="0000 0000 0000 0000">
                                    </div>
                                    <div class="input_container">
                                        <label for="password_field" class="input_label">Expiry Date / CVV</label>
                                        <div class="split">
                                            <input id="password_field" class="input_field" type="text" name="expiry_date" title="Expiry Date" placeholder="01/23">
    ...
    <script>
        ...
        $(document).ready(function(){   
            ...
            // updating quantities before checkout
            $(document).on("click", "#checkout", function(){
                // let quantity = Array();
                let values = parseInt($(".quantity .itemsCount").text());
                let quantity = Array(values);
                alert(quantity);
            ...
            // placing order using checkout 
            $(document).on("submit", "#card-detail-form", function(){
                // alert("Thanks for ordering");
                let card_details = $(this).serialize();

                $.ajax({
                    url : "order_placing.php",
                    method : "POST",
